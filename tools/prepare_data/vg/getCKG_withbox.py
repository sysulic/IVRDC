...
print("compute done")
print("write pkl...")
with  open('/home/lab/LN/new_work/outputs/CKG_'+dataset+'_pro.pkl', 'wb')as fid:
    cp.dump(aa, fid, cp.HIGHEST_PROTOCOL)
with  open('/home/lab/LN/new_work/outputs/CKG_'+dataset+'_box.pkl', 'wb')as fid:
    cp.dump(bb, fid, cp.HIGHEST_PROTOCOL)
with  open('/home/lab/LN/new_work/outputs/CKG_'+dataset+'_numbox.pkl', 'wb')as fid:
